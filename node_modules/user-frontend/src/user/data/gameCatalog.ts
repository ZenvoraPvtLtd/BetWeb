...
export const gameCatalog: CatalogGame[] = [
  ...
  { id: 'g3', name: 'Dolidana', slug: 'dolidana', image: 'https://images.unsplash.com/photo-1518895949257-7621c3c786d7?w=300&auto=format&fit=crop&q=60', category: 'casino', route: '/games/dolidana', enabled: true },
  ...
  { id: 'g8', name: 'Roulette', slug: 'roulette', image: 'https://images.unsplash.com/photo-1518895949257-7621c3c786d7?w=300&auto=format&fit=crop&q=60', category: 'casino', route: '/casino/live', enabled: true },
  ...
  { id: 'g13', name: 'Unlimited Joker 20-20', slug: 'unlimited-joker-20-20', image: 'https://images.unsplash.com/photo-1518895949257-7621c3c786d7?w=300&auto=format&fit=crop&q=60', category: 'teenpatti', route: '/games/teenpatti', enabled: true },
  ...
  { id: 'g18', name: 'Unique Roulette', slug: 'unique-roulette', image: 'https://images.unsplash.com/photo-1518895949257-7621c3c786d7?w=300&auto=format&fit=crop&q=60', category: 'casino', route: '/casino/live', enabled: true },
  ...
  { id: 'g23', name: 'Super Over 2', slug: 'super-over-2', image: 'https://images.unsplash.com/photo-1518895949257-7621c3c786d7?w=300&auto=format&fit=crop&q=60', category: 'mini', route: '/casino/mini', enabled: true },
