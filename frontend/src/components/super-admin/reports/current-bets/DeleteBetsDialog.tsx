    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-xs select-none">
      ...
      >
        ...
        <p className="text-xs md:text-sm text-zinc-500 leading-relaxed mb-6">
          ...
          <strong className="text-zinc-900">{selectedCount}</strong> selected unsettled bet(s)? This
        ...
        <div className="flex justify-end gap-3">
          ...
          <div className="w-[100px]">
            <Button
              ...
              className="bg-red-650 hover:bg-red-500 focus:ring-red-500 active:bg-red-700"
            >
              Delete
            </Button>
          </div>
